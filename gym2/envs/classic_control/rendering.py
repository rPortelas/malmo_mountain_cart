...
try:
    ...
    reraise(suffix="HINT: you can install pyglet directly via 'pip install pyglet'. But if you really just want to install all gym2 dependencies and not have to think about it, 'pip install -e .[all]' or 'pip install gym2[all]' will do it.")
...
class Viewer(object):
    ...
    def render(self, return_rgb_array=False):
        ...
        if return_rgb_array:
            ...
            # In https://github.com/openai/gym2-http-api/issues/2, we
