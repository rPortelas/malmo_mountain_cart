...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None):
    ...
    gym2.utils.play.PlayPlot. Here's a sample code for plotting the reward
    ...
    assert type(obs_s) == gym2.spaces.box.Box
...
if __name__ == '__main__':
    env = gym2.make("MontezumaRevengeNoFrameskip-v4")
