...
class Env(object):
    """The main OpenAI gym2 class. It encapsulates an environment with
    ...
    def unwrapped(self):
        ...
        Returns:
            gym2.Env: The base non-wrapped gym2.Env instance
        """
        return self
...
class GoalEnv(Env):
    """A goal-based environment. It functions just as any regular OpenAI gym2 environment but it
    ...
    def reset(self):
        ...
        if not isinstance(self.observation_space, gym2.spaces.Dict):
            raise error.Error('GoalEnv requires an observation space of type gym2.spaces.Dict')
